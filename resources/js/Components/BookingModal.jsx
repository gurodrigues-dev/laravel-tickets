                         ...
                         <label htmlFor="quantity" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                          ...
                          <div className="mt-1 flex items-center space-x-3">
                              <button
                               ...
                               <div className="flex-1 h-10 sm:h-12 min-w-[60px] flex items-center justify-center rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
                                   <span className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100">{quantity}</span>
                               </div>
                               <button
                                   type="button"
                                   onClick={() => {
