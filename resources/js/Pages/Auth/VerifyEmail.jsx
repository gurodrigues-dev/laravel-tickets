    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                ...
                link we just emailed to you? If you didn't receive email, we will gladly send you another.
            </div>

            {status === 'verification-link-sent' && (
                <div className="mb-4 font-medium text-sm text-green-600 dark:text-green-400">
                    A new verification link has been sent to email address you provided during registration.
                </div>
            )}
